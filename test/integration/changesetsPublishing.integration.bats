...
@test "integration: packed orb includes changesets publishing commands and jobs" {
  ...
  assert_output --partial "promote-prod-release:"
  assert_output --partial "Stage release cycle writer"
  assert_output --partial "WRITE_RELEASE_CYCLE_SCRIPT"
  assert_output --partial "/tmp/chiubaka-release-cycle/writeReleaseCycle.mjs"
