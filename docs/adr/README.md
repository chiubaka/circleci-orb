# Repository ADRs (`chiubaka/circleci-orb`)

Architecture and workflow decisions that apply **only to this repository** (the CircleCI orb and its scripts), distinct from org-wide ADRs under [`org/docs/adr/`](../../org/docs/adr/).
