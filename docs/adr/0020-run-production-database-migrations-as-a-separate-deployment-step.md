...
- [ADR 0039](0039-release-manifest-pin-sets-and-tooling-owned-deploy-order.md) — pin-set coordinated releases; migration ordering relative to application rollout is expressed in the **canonical deploy implementation**, not in `.releases/` manifests
