...
## Stage 3 — Manifests and promotion tags (ADRs 0039–0031)
...
- **`coordinated-deploy` job/command:** setup → validate → user-provided deploy script (ordering owned by repo tooling per ADR 0039).
- Workflow docs: promotion tags vs artifact tags [0031](../../org/docs/adr/0031-separation-of-artifact-tags-and-environment-promotion-tags.md); pin-set manifests [0039](../../org/docs/adr/0039-release-manifest-pin-sets-and-tooling-owned-deploy-order.md).
