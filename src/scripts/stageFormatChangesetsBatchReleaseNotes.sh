#! /usr/bin/env bash
# Materialize formatChangesetsBatchReleaseNotes.mjs for CircleCI consumers (orb packs this script;
# the sibling .mjs is not on disk in the client repo). Keep the heredoc body in sync with
