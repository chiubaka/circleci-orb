...
- [ADR 0039](0039-release-manifest-pin-sets-and-tooling-owned-deploy-order.md) — coordinated deploys pin immutable **artifact tags** named in the manifest; those tags correspond to versioned deployable artifacts in this policy
