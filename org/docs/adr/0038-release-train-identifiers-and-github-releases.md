...
- Release manifest `release` fields and promotion-tag logical ids remain consistent with [ADR 0039](0039-release-manifest-pin-sets-and-tooling-owned-deploy-order.md) and [ADR 0031](0031-separation-of-artifact-tags-and-environment-promotion-tags.md).
